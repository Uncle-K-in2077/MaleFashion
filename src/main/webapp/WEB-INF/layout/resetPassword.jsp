...
<head>
<meta charset="UTF-8">
<title>MaleFashion | Reset Password</title>
          ...
          <div class="card-body p-md-5" style="background-image: url('../img/hero/hero-1.jpg'); background-position: center center; background-size: cover;">
            <div class="row justify-content-center" >
              ...
              <div style="border: 2px solid #F2DFDB; border-style: double; " class="overlay col-md-10 col-lg-9 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-3 mx-1 mx-md-4 mt-4">Verify Account</p>
				
                <form class="mx-1 mx-md-4" action="/login/resetPassword" method="post">

                  <div class="d-flex flex-row align-items-center mb-4">
                    <div class="form-outline flex-fill mb-0">
                      <p style=" color: black;" id="form3Example3c" class="form-control">Reset your passwod</p>
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input placeholder="new Password" required="required" name="newPassword" style="background-color: #D3D3D3; color: black; " type="text" id="form3Example3c" class="form-control" />
                    </div>
                  </div>
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input placeholder="new Password" required="required" name="reNewPassword" style="background-color: #D3D3D3; color: black; " type="text" id="form3Example3c" class="form-control" />
                    </div>
                  </div>
                  <p class="error">${!empty errorMessage3 ? errorMessage3 : '' }</p>
                  <!-- 
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button class="btn btn-primary btn-lg" type="submit">Send  <i class="fas fa-envelope fa-lg fa-fw"></i></button>
                  </div>
