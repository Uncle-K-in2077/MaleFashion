...
<head>
<meta charset="UTF-8">
<title>MaleFashion | Verify OTP</title>
          ...
          <div class="card-body p-md-5" style="background-image: url('../img/hero/hero-1.jpg'); background-position: center center; background-size: cover;">
            <div class="row justify-content-center" >
              ...
              <div style="border: 2px solid #F2DFDB; border-style: double; " class="overlay col-md-10 col-lg-9 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" action="/login/confirmOTP" method="post">

                  <div class="d-flex flex-row align-items-center mb-4">
                    <div class="form-outline flex-fill mb-0">
                      <p style=" color: black;" id="form3Example3c" class="form-control">We will send an OTP code to your registed email: <span style="color: #B07F5E; font-weight: bold;">${verifyEmail }</span></p>
                    </div>
                  </div>
                  ...
                  <p class="error">${!empty errorMessage2 ? errorMessage2 : '' }</p>
                  <!-- 
