...
<link rel="stylesheet" href="./yeti/style.css">
...
<form >
	...
	<div class="inputGroup inputGroup1">
		...
		<input style="font-family: Nunito Sans, sans-serif;" type="email" id="loginEmail" maxlength="254" />
...
<script  src="./yeti/script.js"></script>
