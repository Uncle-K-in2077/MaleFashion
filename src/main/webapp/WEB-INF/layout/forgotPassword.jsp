...
<head>
<meta charset="UTF-8">
<title>MaleFashion | Forgot Pasword</title>
          ...
          <div class="card-body p-md-5" style="background-image: url('../img/hero/hero-1.jpg'); background-position: center center; background-size: cover;">
            <div class="row justify-content-center" >
              ...
              <div style="border: 2px solid #F2DFDB; border-style: double; " class="overlay col-md-10 col-lg-9 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-3 mx-1 mx-md-4 mt-4">Forgot Password </p>
				
                <form class="mx-1 mx-md-4" action="/login/forgot-password" method="post">

                  <div class="d-flex flex-row align-items-center mb-4">
                    <div class="form-outline flex-fill mb-0">
                      <p style=" color: black;" id="form3Example3c" class="form-control">We will send an OTP code to your registed email to your <span style="color: #B07F5E; font-weight: bold;">Registed Email </span>to verify your account</p>
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input placeholder="Your Registed Email" required="required" name="verifyEmail" style="background-color: #D3D3D3; color: black; " type="email" id="form3Example3c" class="form-control" />
                    </div>
                  </div>
